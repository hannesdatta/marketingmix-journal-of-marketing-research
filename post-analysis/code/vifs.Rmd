...
# lag variables
xvars = c('rwpspr', 'wpswdst','llen','nov12sh', 'usalessh')
plusx = c('nov6sh', 'wpswdst', 'nov12sh','wpswdst')
...
# function to compute VIFs ( paste0('lnl',xvars), )
run_vif <- function(.vars = c(paste0('ln', xvars),'lnmonth_no', 'quarter2','quarter3','quarter4')) {
...
xvars=c('rwpspr', 'wpswdst','llen','nov12sh')
...
report(vifs2, tab('VIFs: ln X, no trend, w/ quarter dummies, lagged ln MS'))
