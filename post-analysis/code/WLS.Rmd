...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+local_to_market + as.factor(category) + as.factor(brand),
                          m2=~1+ln_gdppercap2010_mc*local_to_market + as.factor(category) + as.factor(brand)), 
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+western_brand + as.factor(category) + as.factor(brand),
                          m2=~1+ln_gdppercap2010_mc*western_brand + as.factor(category) + as.factor(brand)), 
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+country_of_origin_recode + as.factor(category) + as.factor(brand),
                          m2=~1+ln_gdppercap2010_mc*country_of_origin_recode + as.factor(category) + as.factor(brand)), 
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+ln_ncountry_in_category_mc + as.factor(category) + as.factor(brand), 
                          m2=~1+ln_gdppercap2010_mc*ln_ncountry_in_category_mc + as.factor(category) + as.factor(brand)), dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+ln_ncat_in_country_mc + as.factor(category) + as.factor(brand),
                          m2=~1+ln_gdppercap2010_mc*ln_ncat_in_country_mc + as.factor(category) + as.factor(brand)),
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+ln_market_growth_mc + as.factor(category) + as.factor(brand),
                          m2=~1+ln_gdppercap2010_mc*ln_market_growth_mc + as.factor(category) + as.factor(brand)),
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+ln_herf_mc + as.factor(category) + as.factor(brand),
                          m2=~1+ln_gdppercap2010_mc*ln_herf_mc + as.factor(category) + as.factor(brand)),
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+ln_c5_mc + as.factor(category) + as.factor(brand), 
                          m2=~1+ln_gdppercap2010_mc*ln_c5_mc + as.factor(category) + as.factor(brand)),
                     dat=elast)
...
out=regmodel(formula=list(m1=~1+ln_gdppercap2010_mc+necessity + as.factor(category) + as.factor(brand), 
                          m2=~1+ln_gdppercap2010_mc*necessity + as.factor(category) + as.factor(brand)),
                     dat=elast)
...
## Using WLS, with fixed effects for categories and brands.

```{r combined1, echo = FALSE, results='asis'}

basemodel = ~1+ln_gdppercap2010_mc + as.factor(category) + as.factor(brand)
...
printres(out, omit='[(]brand|[(]category', vars=c('llen'),title='line length')
printres(out, omit='[(]brand|[(]category', vars=c('nov6sh'),title='novelty')
printres(out, omit='[(]brand|[(]category', vars=c('rwpspr'),title='price')
printres(out, omit='[(]brand|[(]category', vars=c('wpswdst'),title='distribution')
```
