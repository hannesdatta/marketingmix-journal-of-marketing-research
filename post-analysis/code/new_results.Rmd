...
Variable                  | Operationalization                                    
-------------------- | ------------------------------------------------------------------
Brand equity       | Sales-based brand equity (Datta et al. 2017), derived from a market-share attraction model, standardized by category.
Brand equity (BAV) | Brand strength, obtained by Young & Rubicam / BAV Consulting for a subset of countries.
Brand equity (BrandZ) | Indicator variable, equaling 1 if brand was listed in BrandZ rankings between 2004 and 2014.
Price index        | Brand's average price, divided by the average price in focal category and country.
Domestic (vs. foreign brand) | Dummy variable, equaling 1 if a brand's headquarter is located in the focal country, 0 if not.
Western brand (vs. non-Western brand) | Indicator variable, equaling 1 if a brand's headquarter is located in a Western country, 0 otherwise.
"Strong" country brand | Indicator variable, equaling 1 if a brand's headquarter is located in Japan, the US, Switzerland, Germany or Sweden, 0 otherwise.
Assortment novelty of brand | A brand's average number of newly introduced SKUs over a rolling window of 6 months, divided by the brand's average line length over the same period.
...
Category novelty | Category average of all brands' assortment novelties (category/country combination)
Category volatility | SD of the category sales in a moving window of 3 months  (category/country combination)
...
^1^ Weights equal to a SKU's unit sales in the most recent quarter (months *t*-2, *t*-1, *t*). Geometric averages used throughout.
