...
```{r elasts_full_median, echo=F,results='asis', warning=FALSE}
...
```{r elast_by_cc, echo=F,results='asis', include=TRUE, warning = FALSE}
...
stargazer(lapply(model_results, function(x) x$model), type= 'html')
