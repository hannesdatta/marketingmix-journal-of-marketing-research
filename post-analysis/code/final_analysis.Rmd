...
tmp=elast[, list(qmeans=sum(elastlt*w_elastlt)/sum(w_elastlt)),
          by=c('variable', 'developed','group')]

tmp2=elast[, list(qmeans=sum(elastlt*w_elastlt)/sum(w_elastlt)),
...
Notes: Figures show mean long-term elasticities per quartile. `r estimnote`
