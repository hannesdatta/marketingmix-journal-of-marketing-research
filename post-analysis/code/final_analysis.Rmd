...
covars <- c('appliance', 'market_growth', 'herf', 'local_to_market', 'sbbe_std', 'sbbe', 'sbbelt', 'overall_ms', 'overall_prindex', 'brandz', 'gci_overall_s', 'gci_sub_basicrequire_s', 'gci_sub_efficiencyenhance_s', 'gci_sub_innovation_s')
...
out=lapply(covars, function(.var) {
  ...
  tmp=elast[!is.na(elastlt), list(meanelast = sum(elastlt*w_elastlt)/sum(w_elastlt)), by = c('variable','emerging','splitvar')]
