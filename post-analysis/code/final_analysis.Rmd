...
```{r testconvergence, echo=FALSE, include=FALSE}
...
Gini index                | Gini index in a country.^1^
...
cat("<P style='page-break-before: always'>")
printout(main, 'stlt', title = tab('Regression with short- and long-term elasticities in a pooled sample of developed and emerging countries, with selected interactions'), vars=ordered_vars,  notes=gsub('long[-]term', 'short- and long-term', notes_base))
