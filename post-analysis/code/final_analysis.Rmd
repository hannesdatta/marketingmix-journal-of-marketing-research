...
kable(sanitize_table(summary_sig), format='html', initial.zero = FALSE, caption=tab('Z-values for adding interactions to a main-effects only model for short-term elasticities')) %>%
        kable_styling()
...
kable(sanitize_table(summary_sig), format='html', initial.zero = FALSE, caption=tab('Z-values for adding interactions to a main-effects only model for long-term elasticities')) %>%
        kable_styling()
