...
summary(lm(elastlt~1+time, data=elast_time[variable=='rwpspr'], weight=1/elastlt_se))
summary(lm(elastlt~1+time, data=elast_time[variable=='wpswdst'], weight=1/elastlt_se))
summary(lm(elastlt~1+time, data=elast_time[variable=='llen'], weight=1/elastlt_se))
