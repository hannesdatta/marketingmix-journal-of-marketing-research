...
# formulas for models
form_main_model = .~1+ (1|brand) + (1|category) + (1|country) + emerging +  ln_market_growth_mc + ln_herf_mc + local_to_market + sbbe_std_mc + ln_overall_prindexavg_mc + appliance + gini_mc

form_main_model_selected_interact = .~1+ (1|brand) + (1|category) + (1|country) + emerging +  ln_market_growth_mc + I(ln_market_growth_mc*emerging) + ln_herf_mc + I(ln_herf_mc*emerging) + local_to_market + I(local_to_market*emerging) + sbbe_std_mc + I(sbbe_std_mc*emerging) + ln_overall_prindexavg_mc + appliance + gini_mc
...
covars <- c('appliance', 'market_growth', 'herf', 'local_to_market', 'overall_prindexavg', 'sbbe_std', 'brandz', 'gini')
...
```{r robustness_regs, echo = TRUE, results='asis'}
...
```{r plotvars,echo=FALSE, include=TRUE}
