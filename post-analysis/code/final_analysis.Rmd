...
pl<-lapply(c(qmeans='qmeans',qwmeans='qwmeans'), function(varplot) {
  ...
  ggplot(tmp[variable==.var], aes(x=group, y=pltv, fill=ifelse(developed==1, 'developed', 'emerging'))) + 
    ...
    labs(title = fig(paste0("", rename.fkt(.var), ifelse(varplot=='qwmeans', ' (weighted)', ''), ""))) + 
...
m2 = ~1+ (1|brand) + (1|category) + (1|country) + emerging + appliance + I(appliance*emerging) + ln_market_growth_mc + I(ln_market_growth_mc*emerging) + ln_herf_mc + I(ln_herf_mc*emerging) + local_to_market + I(local_to_market*emerging) + western_brand + I(western_brand*emerging) + sbbe_std_mc + I(sbbe_std_mc*emerging) + othercountry + I(othercountry*emerging)
...
m1 = ~1+ (1|brand) + (1|category) + as.factor(country) + appliance + ln_market_growth_mc + ln_herf_mc + local_to_market + western_brand + otherbrand + sbbe_std_mc
out5=regmodel(formula=m1, dat=elast, model='lmer')
...
m1 = ~1+ appliance + ln_market_growth_mc + ln_herf_mc + local_to_market + western_brand + otherbrand + sbbe_std_mc
