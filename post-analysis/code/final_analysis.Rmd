...
# Load data
  ...
  elast_adv <- fread('../externals/elast_results_adv.csv') 
...
# Preclean data
  source('preclean.R')
  elast_adv[, brand:=my_capitalize(brand)]
...
# add A15 here: comparison elasticities from lagged X model with focal model
