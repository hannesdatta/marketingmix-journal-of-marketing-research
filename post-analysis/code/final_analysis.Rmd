...
(based on brands for which country-of-origin has been coded)
...
```{r elast_by_cc, echo=F,results='asis', include=FALSE}
sink('cc.html')
for (byvar in c('category', 'country')) {
  ...
  cat("<P style='page-break-before: always'>")
  {print(kable(tmp, digits=3, caption = tab(paste0('Long-term elasticities (by ', byvar, ')^1^'), prefix='A'), format='html', initial.zero = FALSE) %>%
