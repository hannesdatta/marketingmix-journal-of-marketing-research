...
print(kable(sanitize_table(dtf), format='html', initial.zero = FALSE, digits=3,caption = tab(paste0('Mean ', gsub('ity', 'ities', names(var)), ' by brand equity and a country\'s development status^1^'))
