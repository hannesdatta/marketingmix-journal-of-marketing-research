...
#      diff_tests=rbindlist(lapply(unique(elast$variable), function(.var) {
#      data.table(variable=.var, effect=c('constant', 'emerging'), summary(lmer(val~1+(1|category) + (1|country) + (1|brand) + emerging, weights=val_w,data=tmp[variable==.var]))$coefficients)
#    }))
