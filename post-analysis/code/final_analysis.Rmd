...
# Preclean data
  ...
  elast <- fread('../externals/elast_results_firstobs60.csv') 
  source('preclean.R')
  elast_firstobs <- copy(elast)
  
  elast <- fread('../externals/elast_results_lastobs60.csv') 
  source('preclean.R')
...
res = NULL
  ...
  cat(paste0('==========================\n',.var,'\n==============================\n\n\n'))
    ...
    res=rbind(res,c(.var, ifelse(emerg==T,'emerging','developed'),length(unique(elast_time[variable==.var&emerging==emerg]$brandmarket)),means[1,1], means[2,1], wls[1], wls[3], wls[4]))  
