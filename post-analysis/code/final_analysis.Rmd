...
------------------------- | --------------------------------------------------------|----------
Brand strength               | Sales-based brand equity, derived from the market share attraction model, standardized by category. | Datta, Ailawadi, and van Heerde (2017)
...
^1^ All continuous variables are first logged and then mean-centered before model estimation (except brand strength, which is only mean-centered as this variable can take on negative values). 
