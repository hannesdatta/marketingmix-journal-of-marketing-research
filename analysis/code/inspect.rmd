---
title: "Inspection of new elasticities (with standard errors, max 12 lags, kick out ns. coefs, use TS properties of controls)"
output: pdf_document
---
...
library(knitr)
library(kableExtra)
elast <- fread('../output/elasticities_revision_salesresponse_max12_kickoutns_urcontrols.csv')
