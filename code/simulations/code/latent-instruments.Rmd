...
results <- lapply(2:4, function(levels) {
  ...
  return(list(summary=c(levels=levels, endogenous_variables=endogenous_variables, unlist(llik_complete(nlminb$par, levels = levels, endogenous_variables = endogenous_variables, data = data))),rec_pars=rec_pars))
})
...
# does it impact parameter stability --> YES!
lapply(results, function(x) x$rec_pars$gamma)
